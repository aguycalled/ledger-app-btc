...
# Bitcoin testnet
DEFINES   += COIN_P2PKH_VERSION=111 COIN_P2SH_VERSION=196 COIN_P2CS_VERSION=8 COIN_P2CS2_VERSION=32 COIN_FAMILY=2 COIN_COINID=\"NavCoin Testnet\" COIN_COINID_HEADER=\"NAVCOINTEST\" COIN_COLOR_HDR=0xB553FC COIN_COLOR_DB=0xDAA6FF COIN_COINID_NAME=\"NavCoin Testnet\" COIN_COINID_SHORT=\"tNAV\" COIN_KIND=COIN_KIND_NAV_TESTNET COIN_FLAGS=FLAG_PEERCOIN_SUPPORT
APPNAME ="Navcoin Test"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),navcoin)
# Bitcoin mainnet
DEFINES   += COIN_P2PKH_VERSION=53 COIN_P2SH_VERSION=85 COIN_P2CS_VERSION=21 COIN_P2CS2_VERSION=36 COIN_FAMILY=2 COIN_COINID=\"NavCoin\" COIN_COINID_HEADER=\"NAVCOIN\" COIN_COLOR_HDR=0xB553FC COIN_COLOR_DB=0xDAA6FF COIN_COINID_NAME=\"NavCoin\" COIN_COINID_SHORT=\"NAV\" COIN_KIND=COIN_KIND_NAV COIN_FLAGS=FLAG_PEERCOIN_SUPPORT
...
$(error Unsupported COIN - use navcoin, navcoin_testnet)
endif
endif
